...
class AudioFrame(tk.Frame):
    def __init__(self, parent, *args, **kwargs):
        ...
        # Track time info
        self.track_len_label = tk.Label(
            self, text=self.player.curr_track_len, bg=self.BG_COLOR, fg=self.FG_COLOR
        )
        self.track_len_label.pack()

        self.track_time_label = tk.Label(
            self, text=self.player.curr_track_len, bg=self.BG_COLOR, fg=self.FG_COLOR
        )
        ...
        self.curr_artist_label = tk.Label(
            self, text="", bg=self.BG_COLOR, fg=self.FG_COLOR
        )
